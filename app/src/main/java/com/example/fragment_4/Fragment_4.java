...
public class Fragment_4 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View viewFrag4 = inflater.inflate(R.layout.fragment_4, container, false);
         listViewItem= (ListView)viewFrag4.findViewById(R.id.listView_id);
        return viewFrag4;
    }
        ...
        for(int i =0; i<itemNameList.length;i++){
            ...
            switch (i%3){
                ...
                case 1:
                    ...
                    break;
                case 2:
                    data.put("pic",R.drawable.play);
                    data.put("price","1000元");
                    break;
            }
            itemData.add(data);
        }
